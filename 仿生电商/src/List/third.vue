<template>
    ...
    <!-- <router-view></router-view> -->
        ...
        <!-- 小标签 -->
        <div class="bq">
            <!-- <van-tag round  v-for="tab in tabs" :key="tab">{{ tab.text }}</van-tag> -->
            <van-tag round>人工智能</van-tag>
            <van-tag round>数据科学</van-tag>
            <van-tag round>大数据</van-tag>
            <van-tag round>区块链</van-tag>
            <van-tag round>云计算</van-tag>
        </div>
        ...
        <div class="list">
            <div class="xbt">
                ...
                <div class="xbt_r">
                <span class="xr_txt" @click="gengDuo(4)">更多</span>
                <van-icon name="arrow" />
                </div>
            </div>
